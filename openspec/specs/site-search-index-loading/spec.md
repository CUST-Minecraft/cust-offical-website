...
Define how the CUST Minecraft website loads the global search index without making content search data a first-render dependency. The capability covers first-render non-preloading, search-open lazy loading, loading/error states, and public Nuxt BFF data boundaries.
