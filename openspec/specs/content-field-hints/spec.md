...
Define the maintenance-facing content field hint mode for the public website, including its Minecraft-style trigger button, non-layout overlay behavior, and minimal field metadata shown to content maintainers.
